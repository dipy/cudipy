...
from cudipy.segment._cupy import _util
...
# Note: added a has_channel parameter here for cudipy that was not in the
...
def _generate_nd_kernel(name, pre, found, post, mode, w_shape, int_type,
                        ...
                        binary_morphology=False, has_channel=False):
